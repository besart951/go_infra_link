...
Generated: 2026-08-22T11:19:28Z
...
- `database_bytes`: `28790978239`
- `expected_field_devices`: `5000000`
- `field_device_cursor_values_index_bytes`: `9434775552`
- `field_device_cursor_values_rows`: `5000000`
- `field_device_cursor_values_table_bytes`: `560734208`
- `field_devices_bmk_null_rows`: `1000000`
- `field_devices_index_bytes`: `5601574912`
- `field_devices_rows`: `5000000`
- `field_devices_table_bytes`: `876437504`
- `project_field_devices_index_bytes`: `1732026368`
- `project_field_devices_rows`: `5000000`
- `project_field_devices_table_bytes`: `505683968`
- `schema_migrations`: `32`
- `search_0_1_percent_rows`: `0`
- `search_10_percent_rows`: `350000`
- `search_1_percent_rows`: `375000`
- `specification_supplier_null_rows`: `833334`
- `specifications_index_bytes`: `9299984384`
- `specifications_rows`: `5000000`
- `specifications_table_bytes`: `713498624`
...
|---|---:|---:|---:|---:|---:|---:|---|
| search_10_percent_next | 15 | 0 | 0.0000% | 19.51 | 31.93 | 31.93 | false |
