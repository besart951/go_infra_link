...
Shared frontend internationalization package.
...
- **Translation files**: `src/lib/translations/de_CH.json`
- **i18n store**: `src/lib/index.ts`
- **Translator utility**: `src/lib/translator.ts`
...
1. Open `src/lib/translations/de_CH.json`
...
1. Create `src/lib/translations/en_US.json`
2. Update the `translations` object in `src/lib/index.ts`
