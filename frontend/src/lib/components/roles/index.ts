// Role components barrel export
export { default as RoleCard } from './RoleCard.svelte';
export { default as PermissionForm } from './PermissionForm.svelte';
...
export { default as ResourceSection } from './ResourceSection.svelte';
export { default as PermissionItem } from './PermissionItem.svelte';
