...
export interface ProjectRepository extends ListRepository<Project> {
  ...
  addObjectData(projectId: string, objectDataId: string, signal?: AbortSignal): Promise<void>;
  removeObjectData(projectId: string, objectDataId: string, signal?: AbortSignal): Promise<void>;
