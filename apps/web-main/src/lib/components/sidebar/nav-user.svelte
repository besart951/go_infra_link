<script lang="ts">
  import * as Avatar from '@ui-svelte/components/ui/avatar/index.js';
  ...
  import { useSidebar } from '@ui-svelte/components/ui/sidebar/index.js';
  import { setThemePreference, initTheme } from '@theme/theme.js';
