<script lang="ts">
  ...
  import { Input } from '@ui-svelte/components/ui/input/index.js';
  import { Label } from '@ui-svelte/components/ui/label/index.js';
  import { Textarea } from '@ui-svelte/components/ui/textarea/index.js';
...
>
  <div class="mb-4 flex items-center justify-between">
    <h3 class="text-lg font-medium">
      {initialData
        ? $t('facility.forms.notification_class.title_edit')
        : $t('facility.forms.notification_class.title_new')}
    </h3>
  </div>
  ...
  <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
    ...
    <div class="space-y-2">
      <Label for="nc_object_desc"
        >{$t('facility.forms.notification_class.object_description')}</Label
      >
    ...
    <div class="space-y-2">
      <Label for="nc_internal_desc"
        >{$t('facility.forms.notification_class.internal_description')}</Label
      >
    ...
    <div class="space-y-2">
      <Label for="nc_norm_not_normal"
        >{$t('facility.forms.notification_class.norm_not_normal')}</Label
      >
