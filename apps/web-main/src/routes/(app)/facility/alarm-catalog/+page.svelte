<script lang="ts">
  ...
  import { Checkbox } from '@ui-svelte/components/ui/checkbox/index.js';
  import * as Card from '@ui-svelte/components/ui/card/index.js';
  import * as Table from '@ui-svelte/components/ui/table/index.js';
  ...
  <div class="grid gap-6 xl:grid-cols-2">
      ...
      <Card.Content class="space-y-4">
        ...
        <div class="flex justify-end">
          {#if canPerform('create', 'alarmtype')}
            <Button
              onclick={createUnit}
              disabled={!unitForm.code || !unitForm.symbol || !unitForm.name}
            >
              Einheit erstellen
            </Button>
          {/if}
    ...
    <Card.Root>
      <Card.Header class="border-b">
        ...
        <Card.Description
          >Definition von Key, Datentyp und optionaler Standard-Einheit.</Card.Description
        >
      </Card.Header>
      <Card.Content class="space-y-4">
  ...
  <div class="grid gap-6 xl:grid-cols-2">
    ...
    <Card.Root>
      <Card.Header class="border-b">
        ...
        <Card.Description
          >Zuordnung von Feldern zu Alarmtypen inkl. Reihenfolge und Regeln.</Card.Description
        >
      </Card.Header>
      <Card.Content class="space-y-4">
        <div class="space-y-2">
                  ...
                  {#each typeFields as tf}
                    <Table.Row>
                      <Table.Cell class="font-medium"
                        >{tf.alarm_field?.label ?? tf.alarm_field_id}</Table.Cell
                      >
