<script lang="ts">
  ...
  import * as Breadcrumb from '@ui-svelte/components/ui/breadcrumb/index.js';
  import { Separator } from '@ui-svelte/components/ui/separator/index.js';
  ...
  const titleForPath = (pathname: string) => {
    ...
    if (pathname.startsWith('/facility/alarm-catalog')) return t('navigation.alarm_catalog');
