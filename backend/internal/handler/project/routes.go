...
func RegisterProjectRoutes(protectedV1 *gin.RouterGroup, handlers *Handlers) {
	projects := protectedV1.Group("/projects")
	{
		...
		projects.GET("/:id/facility/buildings/:buildingId", handlers.FacilityDetail.GetBuilding)
		projects.GET("/:id/facility/control-cabinets/:controlCabinetId", handlers.FacilityDetail.GetControlCabinet)
		projects.PATCH("/:id/facility/control-cabinets/:controlCabinetId", handlers.FacilityDetail.UpdateControlCabinet)
		projects.GET("/:id/facility/sps-controllers/:spsControllerId", handlers.FacilityDetail.GetSPSController)
		projects.PATCH("/:id/facility/sps-controllers/:spsControllerId", handlers.FacilityDetail.UpdateSPSController)
		projects.GET("/:id/facility/sps-controller-system-types/:spsControllerSystemTypeId", handlers.FacilityDetail.GetSPSControllerSystemType)
		projects.PATCH("/:id/facility/sps-controller-system-types/:spsControllerSystemTypeId", handlers.FacilityDetail.UpdateSPSControllerSystemType)
		projects.GET("/:id/facility/field-devices/:fieldDeviceId", handlers.FacilityDetail.GetFieldDevice)
		projects.PATCH("/:id/facility/field-devices/:fieldDeviceId", handlers.FacilityDetail.UpdateFieldDevice)
...
func RegisterPhaseRoutes(protectedV1 *gin.RouterGroup, handlers *Handlers, authChecker middleware.AuthorizationChecker) {
	...
	phasePermissions.Use(middleware.RequirePermission(authChecker, domainUser.PermissionPhasePermissionManage))
	{
		phasePermissions.GET("", handlers.PhasePermission.ListPhasePermissions)
		phasePermissions.POST("", handlers.PhasePermission.CreatePhasePermission)
		phasePermissions.GET("/:id", handlers.PhasePermission.GetPhasePermission)
		phasePermissions.PATCH("/:id", handlers.PhasePermission.UpdatePhasePermission)
		phasePermissions.PUT("/:id", handlers.PhasePermission.UpdatePhasePermission)
		phasePermissions.DELETE("/:id", handlers.PhasePermission.DeletePhasePermission)
	}
}
