...
func Routes(handlers Handlers) []routing.Definition {
	return []routing.Definition{
		...
		routing.Patch("/buildings/:id", domainUser.PermissionBuildingUpdate, handlers.UpdateBuilding),
		...
		routing.Patch("/control-cabinets/:id", domainUser.PermissionControlCabinetUpdate, handlers.UpdateControlCabinet),
		...
		routing.Put("/sps-controller-system-types/:id", domainUser.PermissionSPSControllerSystemTypeUpdate, handlers.UpdateSPSControllerSystemType),
