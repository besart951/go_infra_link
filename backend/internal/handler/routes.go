...
func RegisterRoutes(r *gin.Engine, handlers *Handlers, tokenValidator domainAuth.TokenValidator, authChecker middleware.AuthorizationChecker, userStatusSvc middleware.UserStatusService) {
	...
	projects := protectedV1.Group("/projects")
	{
		...
		projects.POST("/:id/control-cabinets/:controlCabinetId/copy", handlers.ProjectHandler.CopyProjectControlCabinet)
		...
		projects.POST("/:id/sps-controllers/:spsControllerId/copy", handlers.ProjectHandler.CopyProjectSPSController)
		projects.POST("/:id/sps-controller-system-types/:systemTypeId/copy", handlers.ProjectHandler.CopyProjectSPSControllerSystemType)
	...
	facility := protectedV1.Group("/facility")
	{
		...
		facility.POST("/control-cabinets/:id/copy", handlers.FacilityControlCabinetHandler.CopyControlCabinet)
		...
		facility.POST("/sps-controllers/:id/copy", handlers.FacilitySPSControllerHandler.CopySPSController)
