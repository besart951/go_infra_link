...
func NewRepositories(db *sql.DB, driver string) (*Repositories, error) {
	...
	return &Repositories{
		...
		FacilityBuildings:                facilityrepo.NewBuildingRepository(db),
		FacilitySystemTypes:              facilityrepo.NewSystemTypeRepository(db),
		FacilitySystemParts:              facilityrepo.NewSystemPartRepository(db),
		FacilitySpecifications:           facilityrepo.NewSpecificationRepository(db, driver),
		FacilityApparats:                 facilityrepo.NewApparatRepository(db),
